package com.better.anime.asomeview;
 ...
 * -----------------------------------------------------------------
 * <p>
 * File: ShadowDrawableWrapper.java
 * Author: Better
 * Create: 2018/2/24 16:50
 * <p>
 * Changes (from 2018/2/24)
 * -----------------------------------------------------------------
 * 2018/2/24 : Create ShadowDrawableWrapper.java (梁惠涌);
 * -----------------------------------------------------------------
 */
...
public class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    public ShadowDrawableWrapper(Drawable content, float radius,
