...
public class ShadowLayout extends FrameLayout {
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        ...
        try {
            mCornerRadius = attr.getDimension(R.styleable.ShadowLayout_sl_cornerRadius, getResources().getDimension(R.dimen.b_dp4));
            mShadowRadius = attr.getDimension(R.styleable.ShadowLayout_sl_shadowRadius, getResources().getDimension(R.dimen.b_dp4));
